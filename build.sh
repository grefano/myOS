...
~/opt/cross/bin/i686-elf-gcc -g -T linker.ld -o myos -ffreestanding -fno-omit-frame-pointer -nostdlib boot.o kernel.o vga.o input.o gdt.o inlineas.o pic.o excepthandler.o macros.o ssfn.o lanapixel.o -lgcc
